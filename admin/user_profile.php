...
if(isset($_POST['update'])){
    ...
    $update_user = "update admins set admin_name='$user_name',admin_email='$user_email',admin_pass='$user_pass',admin_contact='$user_contact',admin_about='$user_about' where admin_id='$user_id'";
