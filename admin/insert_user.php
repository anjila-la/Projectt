               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="admin_pass" type="password" class="form-control" id="passw" required>
                          <br />
...
if(isset($_POST['submit'])){
    ...
    $insert_user = "insert into admins (admin_name,admin_email,admin_pass,admin_contact,admin_about) values ('$user_name','$user_email','$user_pass','$user_contact','$user_about')";
    
    $run_user = mysqli_query($conn,$insert_user);
    
    if($run_user){
        
        echo "<script>alert('New User has been added to admin sucessfully')</script>";
